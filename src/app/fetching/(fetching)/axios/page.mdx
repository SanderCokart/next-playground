...
<a href="https://nextjs.org/docs/app" target="_blank">'app router'</a>
people have started reverting to native fetch. The reason behind this is that: "Next.js
<a href="https://nextjs.org/docs/app/api-reference/functions/fetch" target="_blank">extends</a>
the native
<a href="https://developer.mozilla.org/docs/Web/API/Fetch_API" target="_blank">Web fetch()</a>
...
```javascript showLineNumbers title="api.ts"
